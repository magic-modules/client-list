...
var pages = {
  '/library-list/': function libraryList(state) {
    return [h1(state.title), p(['this is the ', Link({
      to: 'https://github.com/magic-modules'
    }, '@magic-modules'), ' LibraryList component. ', state.description]), GitBadges('magic-modules/library-list'), h2({
      id: 'installation'
    }, 'installation'), Pre('npm install @magic-modules/library-list'), h2({
      id: 'usage'
    }, 'usage'), p('in a page or module View'), Pre('export const View = () => LibraryList()'), h2({
      id: 'demo'
    }, 'demo'), p('this is what it looks like'), LibraryList(), h2({
      id: 'source'
  ...
  '/library-list/404/': function libraryList404() {
